                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.H1("₱0.00", id="acc_total_revenue_card", style={"textAlign": "center"}),
                                ],
                                style={
                                    "display": "flex",
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.H1("₱0.00", id="acc_net_income_card", style={"textAlign": "center"}),
                                ],
                                style={
                                    "display": "flex",
                                    "flexDirection": "column",
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.H1("0", id="acc_total_orders_card", style={"textAlign": "center"}),
                                ],
                                style={
                                    "display": "flex",
                                    "flexDirection": "column",
...
@app.callback(
    [Output("accounting_greeting", "children"),
     Output("acc_total_revenue_card", "children"),
     Output("acc_net_income_card", "children"),
     Output("acc_total_orders_card", "children")],
    [Input("current_user_id", "data")]
)
def update_accounting_dashboard(user_id):
    # Default values
    greeting = "Hello!"
    revenue_text = "₱0.00"
