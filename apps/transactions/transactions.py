                    ...
                    dbc.Col(
                        [
                            ...
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        html.Div("Total Revenues", id="inventory-report", className="report-link mb-2"),
                                        html.Div("Total Expenses", id="sales-report", className="report-link mb-2"),
                                        html.Div("Net Income", id="financial-report", className="report-link"),
                                    ]
                                ),
